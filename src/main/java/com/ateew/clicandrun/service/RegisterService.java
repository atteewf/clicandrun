...
public class RegisterService {
    ...
    public User register(RegisterDto dto) {
        ...
        if(userRepository.findByEmail(dto.getEmail()) !=null) throw new EmailAlreadyExistsException(dto.getEmail());

        Athlete athlete = athleteRepository.findByFirstNameAndLastNameAndBirthDate(dto.getFirstName(), dto.getLastName(), dto.getBirthDate());
